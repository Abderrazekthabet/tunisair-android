...
public class AgenceAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.txtPays.setText(mAgences.get(position).getPays());
		holder.txtVille.setText(mAgences.get(position).getVille());
		holder.txtAdresse.setText(mAgences.get(position).getAdresse());
		holder.txtTel.setText(mAgences.get(position).getTel());
		holder.txtFax.setText(mAgences.get(position).getFax());
		holder.txtMail.setText(mAgences.get(position).getMail());
